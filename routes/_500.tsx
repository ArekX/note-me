...
export default function Error500({ error }: PageProps) {
  const statusCode = (error instanceof Deno.errors.PermissionDenied) ? 403 : 500;
  const message = (error instanceof Deno.errors.PermissionDenied) ? "Permission Denied" : "Internal Server Error";
  return (
    <>
      <Head>
