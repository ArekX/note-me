    ...
    return (
        <div class="relative">
            ...
            <form autocomplete="off">
                ...
                <input
                    class="transition-colors outline-hidden border-1 pl-9 pr-9 focus:border-gray-600 border-transparent border-t bg-gray-700/30 hover:bg-gray-700 focus:bg-gray-700 p-2 w-full"
                    placeholder={queryPlaceHolder}
                    value={search.query.value}
                    onInput={(e) =>
                        search.setQuery((e.target as HTMLInputElement).value)}
                    name="search-input-unique"
                    autocomplete="off"
                />
            </form>
